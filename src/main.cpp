...
#if defined(NDEBUG)
# error "DV8Coin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "DV8 Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    if (IsProofOfStake())
    {
        // DV8Coin: Check address's staking, can't stake more than MinStakingBeforeSuperblock
...
#ifdef ENABLE_WALLET
// DV8Coin: attempt to generate suitable proof-of-stake
